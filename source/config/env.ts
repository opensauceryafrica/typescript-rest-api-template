        ...
        template: {
            branding: {
                html: (title: string, body: string) => {
                    return `<!doctypehtml><html lang=en><meta charset=UTF-8><meta content="width=device-width,initial-scale=1"name=viewport><title>Account Signin Alert</title><body style=margin:0;padding:0;background-color:#0f1115;font-family:Arial,Helvetica,sans-serif><table cellpadding=0 cellspacing=0 style="background-color:#0f1115;padding:24px 0"width=100%><tr><td align=center><table cellpadding=0 cellspacing=0 style=max-width:520px;background-color:#151821;border-radius:12px;padding:32px width=100%><tr><td style=padding-bottom:24px><table cellpadding=0 cellspacing=0 align=left><tr><td style=padding-right:8px valign=middle><img src=https://typescript-rest-api-templateexchange.com/logo.png style=display:block width=36 height=36 alt=typescript-rest-api-template><td valign=middle><span style=color:#1f4fd8;font-size:26px;font-weight:700;font-family:Arial,Helvetica,sans-serif;line-height:1;letter-spacing:-.3px>typescript-rest-api-template</span></table><tr><td style=color:#fff;font-size:22px;font-weight:700;padding-bottom:16px>${title}<tr><td style=color:#d1d5db;font-size:15px;padding-bottom:12px>${body}<tr><td style=color:#9ca3af;font-size:13px;line-height:1.6;padding-bottom:24px>Questions or concerns? Reach us at <a href=mailto:support@typescript-rest-api-templateexchange.com style=color:#60a5fa;text-decoration:none>support@typescript-rest-api-templateexchange.com </a>or call <a href=tel:+2347052014541 style=color:#60a5fa;text-decoration:none>+234 705 201 4541</a><tr><td style=color:#d1d5db;font-size:14px;padding-bottom:20px>Regards,<br><strong>typescript-rest-api-template.</strong><tr><td style=color:#9ca3af;font-size:12px;line-height:1.6;padding-bottom:20px>Your platform for trading crypto and paying utility bills. Download our app for Android and iOS.<tr><td style=padding-top:16px align=center><table cellpadding=0 cellspacing=0 align=center><tr><td style=padding-right:10px;line-height:0 align=center valign=middle><a href="https://play.google.com/store/apps/details?id=com.opensaucery.typescript-rest-api-templatep"style=display:inline-block;margin-right:10px><img src=https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png style=display:block width=140></a><td style=line-height:0 align=center valign=middle><a href=https://apps.apple.com/us/app/typescript-rest-api-template/id6747611208><img src=https://image2url.com/images/1765997020118-13fc10e3-d6c6-4098-bb2a-14fcf033842a.png style=display:block width=125 height=35></a></table></table></table>`;
                },
            },
            passwordReset: {
